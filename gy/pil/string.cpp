...
namespace std
{
	template <typename T> str16_t _to_u16string(T const &i)
	{
	...
	str16_t to_u16string(int __val) { return _to_u16string(__val); }
	str16_t to_u16string(unsigned __val) { return _to_u16string(__val); }
	str16_t to_u16string(long __val) { return _to_u16string(__val); }
	str16_t to_u16string(unsigned long __val) { return _to_u16string(__val); }
	str16_t to_u16string(long long __val) { return _to_u16string(__val); }
	str16_t to_u16string(unsigned long long __val) { return _to_u16string(__val); }
	str16_t to_u16string(float __val) { return _to_u16string(__val); }
	str16_t to_u16string(double __val) { return _to_u16string(__val); }
	str16_t to_u16string(long double __val) { return _to_u16string(__val); }
...
str8_t str16to8(const c16_t wbcs)
{
	...
	std::wstring_convert<std::codecvt_utf8_utf16<c16_t>, c16_t> converter;
	mbcs = converter.to_bytes(wbcs);
#endif
	return mbcs;
}
